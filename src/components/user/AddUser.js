        ...
        <>
            <div className='container-add m-auto shadow-light my-5 shadow px-4 py-5 rounded'>
                <form onSubmit={e => onSubmit(e)}>
                    <div className="mb-3">
                        <input type="text" className="form-control" id="in1" name='product_name' onChange={e => inputChnage(e)} placeholder="Product Name" />
                    </div>
                    <div className="mb-3">
                        <input type="number" className="form-control" id="in2" name='quantity' onChange={e => inputChnage(e)} placeholder="Quantity" />
                    </div>
                    <div className="mb-3">
                        <input type="text" className="form-control" id="in3" name='img_url' onChange={e => inputChnage(e)} placeholder="Img_URL" />
                    </div>
                    <div className="mb-3">
                        <input type="text" className="form-control" id="in5" name='brand_name' onChange={e => inputChnage(e)} placeholder="Enter your Brand name" />
                    </div>
